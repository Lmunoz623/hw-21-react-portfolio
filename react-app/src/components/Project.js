    ...
    return (
        <div>
            ...
            <div class="card mb-3" style={{maxWidth: "750px"}}>
                <div class="row no-gutters">
                <div class="col-md-4">
                    <img src={googleBooks} class="screenshot" alt="google books application screenshot"/>
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                    <h5 class="card-title">Google Books App</h5>
                    <p class="card-text">This is an appication to search for books and add the books to a reading list.</p>
                    <h6 class="card-text">Github Repository</h6>
                    <a  class="card-text" href="https://github.com/Lmunoz623/hw-google-books-search">https://github.com/Lmunoz623/hw-google-books-search</a> 
                    <h6 class="card-text">Deployed Application</h6>
                    <a  class="card-text" href="https://lmunoz623.github.io/hw-google-books-search/">https://lmunoz623.github.io/hw-google-books-search/</a> 
                    <p class="card-text"><small class="text-muted">Created December 2020</small></p>
                    </div>
                </div>
                </div>
            </div>
            <div class="card mb-3" style={{maxWidth: "750px"}}>
                <div class="row no-gutters">
                <div class="col-md-4">
                    <img src={dailyPlanner} class="screenshot" alt="daily planner application screenshot"/>
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                    <h5 class="card-title">Daily Planner</h5>
                    <p class="card-text">Daily planner is an app where you can add tasks by the hour. The tasks can be saved and edited.</p>
                    <h6 class="card-text">Github Repository</h6>
                    <a  class="card-text" href="https://github.com/Lmunoz623/hw-5-3rdPartyAPI-daily-planner">https://github.com/Lmunoz623/hw-5-3rdPartyAPI-daily-planner</a> 
                    <h6 class="card-text">Deployed Application</h6>
                    <a  class="card-text" href="https://lmunoz623.github.io/hw-5-3rdPartyAPI-daily-planner/">https://lmunoz623.github.io/hw-5-3rdPartyAPI-daily-planner/</a> 
                    <p class="card-text"><small class="text-muted">Created August 2020</small></p>
                    </div>
                </div>
                </div>
